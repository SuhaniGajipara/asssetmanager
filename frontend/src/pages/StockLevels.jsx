...
const StockLevels = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      <PageHeader title="Stock Levels" subtitle="View granular stock availability." action={<Button variant="white" onClick={() => setIsModalOpen(true)} className="flex items-center gap-2 px-4 py-2"><Plus size={18} /> Add New</Button>} />
