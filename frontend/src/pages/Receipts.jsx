...
const Receipts = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      <PageHeader title="Receipts" subtitle="Manage incoming goods receipts." action={<Button onClick={() => setIsModalOpen(true)} className="bg-primary hover:bg-primary/90 text-white flex items-center gap-2 px-4 py-2 rounded-md"><Plus size={18} /> Add New</Button>} />
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-primary-container border-b border-outline-variant/50 text-primary text-sm">
                <th className="py-3 px-6 font-semibold">PO ID</th><th className="py-3 px-6 font-semibold">Warehouse</th><th className="py-3 px-6 font-semibold">Received By</th><th className="py-3 px-6 font-semibold">Status</th>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title="Add Receipts" footer={<><Button variant="ghost" onClick={() => setIsModalOpen(false)}>Cancel</Button><Button variant="primary" type="submit" form="addForm">Save</Button></>}>
