    ...
    <div className="space-y-8 pb-12 max-w-[1400px] mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="bg-surface border border-outline-variant rounded-md px-3 py-1.5 text-sm text-on-surface font-medium flex items-center gap-2 shadow-sm">
            <span className="w-2 h-2 rounded-full bg-info animate-pulse"></span> Live Updates
          </div>
          ...
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={stockInVsOut} margin={{ top: 5, right: 30, left: 0, bottom: 5 }}>
                ...
                <Bar dataKey="stockIn" name="Stock In" fill="#3b82f6" radius={[4, 4, 0, 0]} barSize={24} />
                <Bar dataKey="stockOut" name="Stock Out" fill={isDark ? "#475569" : "#94a3b8"} radius={[4, 4, 0, 0]} barSize={24} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
