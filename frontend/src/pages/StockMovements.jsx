...
const StockMovements = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      <PageHeader title="Stock Movements" subtitle="Track all stock ins and outs." action={<Button onClick={() => setIsModalOpen(true)} className="bg-primary hover:bg-primary/90 text-white flex items-center gap-2 px-4 py-2 rounded-md"><Plus size={18} /> Add New</Button>} />
