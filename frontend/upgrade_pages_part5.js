...
const customersContent = `import React, { useState } from 'react';
...
const suppliersContent = `import React, { useState } from 'react';
...
fs.writeFileSync(path.join(pagesDir, 'Customers.jsx'), customersContent);
fs.writeFileSync(path.join(pagesDir, 'Suppliers.jsx'), suppliersContent);
console.log('Updated Customers and Suppliers');
