...
const categoriesContent = `import React, { useState } from 'react';
...
const warehousesContent = `import React, { useState } from 'react';
...
fs.writeFileSync(path.join(pagesDir, 'Categories.jsx'), categoriesContent);
fs.writeFileSync(path.join(pagesDir, 'Warehouses.jsx'), warehousesContent);
console.log('Updated Categories and Warehouses');
